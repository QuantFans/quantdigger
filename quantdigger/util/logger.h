#ifndef QuantDigger_UTIL_LOGGER_H

#define QuantDigger_UTIL_LOGGER_H

#ifndef WINDOWS
#include <quantdigger/thirdparty/Logger.h>
...
#endif /* end of include guard: QuantDigger_UTIL_LOGGER_H */
